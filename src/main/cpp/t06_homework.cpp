    ...
    while (cin >> homework)
    {
        ...
        if (dic.count(homework)==0)
        {
            ...
            if (high == 1)
            {
                ...
                {
                    homework[i] = tolower(homework[i]);
                }
                for (int i = 0; i < homework.length(); i++)
                {
                    homework[i] = toupper(homework[i]);
                    if (dic.count(homework) == 1)
                        in = true;
                    homework[i] = tolower(homework[i]);//codacy come plzzzzz
                }
            }
            if ((high != 1) || (in))
                err++;
